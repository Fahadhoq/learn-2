...
if(!empty($_SESSION["shopping_cart"]))
{
 foreach($_SESSION["shopping_cart"] as $keys => $values)
 {
  ...
  <tr>
   ...
   <td align="right">$ '.number_format($values["quantity"] * $values["product_price"], 2).'</td>
  </tr>
  ';
        ...
        <div class="form-group">
         <label><b>Card Holder Name <span class="text-danger">*</span></b></label>
           ...
           <div class="row">
            ...
            <div class="col-sm-6">
             <div class="form-group">
              <label><b>PIN NUMBER <span class="text-danger">*</span></b></label>
...
Stripe.setPublishableKey('pk_test_51Itp0FFvKs4uGiJ9d5f1SioDjkjWAd7SQ2pKCEB2n9WMemj0L13DVMiICMu7yezNrO3aedUPrgWvDj8KIUuPh9Sm00vxaHRF3x');
...
<!-- Validate Payment form data end -->