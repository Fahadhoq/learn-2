...
if(isset($_POST["token"]))
{
 ...
 \Stripe\Stripe::setApiKey('sk_test_51Itp0FFvKs4uGiJ9IxPAxAyWFHH6eCrBOMx6EFxO7YYwW4ARW1A376DJyCi5dbihRXom3gfuO6kff6wSegaQ9sLS00ek2K1q73');
 ...
 if($response["amount_refunded"] == 0 && empty($response["failure_code"]) && $response['paid'] == 1 && $response["captured"] == 1 && $response['status'] == 'succeeded')
 {
  ...
  foreach($_SESSION["shopping_cart"] as $keys => $values)
  {
   $order_item_data = array(
    ...
    ':order_item_quantity' => $values["quantity"],
